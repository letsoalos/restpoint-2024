        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Branches_ContactPeople_ContactPersonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_AssetTypes_AssetTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FamilyMembers_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClientId = table.Column<int>(type: "int", nullable: false),
                    DeceasedName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    EventDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ServiceLocation = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuneralEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FuneralEvents_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FuneralEvents_ServiceTypes_ServiceTypeId",
                        column: x => x.ServiceTypeId,
                        principalTable: "ServiceTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FuneralEvents_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FuneralEvents_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FuneralEventId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResourceAllocations_FuneralEvents_FuneralEventId",
                        column: x => x.FuneralEventId,
                        principalTable: "FuneralEvents",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ResourceAllocations_ResourceTypes_ResourceTypeId",
                        column: x => x.ResourceTypeId,
                        principalTable: "ResourceTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ResourceAllocations_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FamilyMembers_StatusId",
                table: "FamilyMembers",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuneralEvents_ClientId",
                table: "FuneralEvents",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_FuneralEvents_ServiceTypeId",
                table: "FuneralEvents",
                column: "ServiceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_FuneralEvents_StatusId",
                table: "FuneralEvents",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_FuneralEvents_VehicleId",
                table: "FuneralEvents",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_IncidentRecords_StatusId",
                table: "IncidentRecords",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_IncidentRecords_VehicleId",
                table: "IncidentRecords",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceAllocations_FuneralEventId",
                table: "ResourceAllocations",
                column: "FuneralEventId");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceAllocations_ResourceTypeId",
                table: "ResourceAllocations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleMaintenances_ServiceTypeId",
